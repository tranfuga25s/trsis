 ...
 */
	...
	public function actualizarUso( $num_cliente, $cantidad, $tam ) {
		$data = $this->find( 'first', array( 'conditions' => array( 'usuario_id' => $num_cliente, 'servicio_id' => $id_servicio ), 'recursive' => -1 ) );
