...
<div class="row-fluid">
    <div class="span11 well">
        <h4><?php echo $this->Html->image( 'modulos/clientes.png', array( 'border' => 0, 'heigth' => 20, 'width' => 20 ) ); ?>&nbsp;Clientes</h4>
...
<div class="row-fluid">
    <div class="span11 well">
        <h4><?php echo $this->Html->image( 'modulos/compras.png'      , array( 'border' => 0, 'heigth' => 20, 'width' => 20  ) ); ?>&nbsp;Compras</h4>
...
<div class="row-fluid">
    <div class="span11 well">
        <h3><?php echo $this->Html->image( 'modulos/presupuesto.png', array( 'border' => 0, 'heigth' => 20, 'width' => 20  ) ); ?>&nbsp;Presupuestos</h3>
...
<div class="row-fluid">
    <div class="span11 well">
        <h3><?php echo $this->Html->image( 'modulos/ventas.jpg', array( 'border' => 0, 'heigth' => 20, 'width' => 20  ) ); ?>&nbsp;Facturas</h3>
...
<div class="row-fluid">
    <div class="span11 well">
        <h3><?php echo $this->Html->image( 'modulos/recibo.png', array( 'border' => 0, 'heigth' => 20, 'width' => 20  ) ); ?>&nbsp;Recibos</h3>
...
<div class="row-fluid">
    <div class="span11 well">
        <h3><?php echo $this->Html->image( 'modulos/ctacte.png', array( 'border' => 0, 'heigth' => 20, 'width' => 20  ) ); ?>&nbsp;Cuentas Corrientes</h3>
...
<div class="row-fluid">
    <div class="span11 well">
        <h3><?php echo $this->Html->image( 'modulos/caja.png'   , array( 'border' => 0, 'heigth' => 20, 'width' => 20  ) ); ?>&nbsp;Control de caja</h3>
...
<div class="row-fluid">
    <div class="span11 well">
        <h3><?php echo $this->Html->image( 'modulos/productos.png', array( 'border' => 0, 'heigth' => 20, 'width' => 20  ) ); ?>&nbsp;Productos</h3>
...
<div class="row-fluid">
    <div class="span11 well">
        <h3><?php echo $this->Html->image( 'modulos/proveedores.jpg', array( 'border' => 0, 'heigth' => 20, 'width' => 20  ) ); ?>&nbsp;Proveedores</h3>
...
<div class="row-fluid">
    <div class="span11 well">
        <h3><?php echo $this->Html->image( 'modulos/servicios.png', array( 'border' => 0, 'heigth' => 20, 'width' => 20  ) ); ?>&nbsp;Servicio de suscripci&oacute;n</h3>
