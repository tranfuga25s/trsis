...
<script>
	$( function() {
		$("#modulos" ).accordion({ active: false, navigation: true, animated: "bounceslide" });
	}); 
</script>
<p>
	El programa contiene los siguientes módulos. Haga click sobre el titulo para ver una descripción sobre cada uno.
</p>
<div id="modulos">
	<h3><a href="#"><?php echo $this->Html->image( 'modulos/clientes.png', array( 'border' => 0, 'heigth' => 20, 'width' => 20 ) ); ?>&nbsp;Clientes</a></h3>
	<div>
	...
	<h3><a href="#"><?php echo $this->Html->image( 'modulos/compras.png'      , array( 'border' => 0, 'heigth' => 20, 'width' => 20  ) ); ?>&nbsp;Compras</a></h3>
	<div>
	...
	<h3><a href="#"><?php echo $this->Html->image( 'modulos/presupuesto.png', array( 'border' => 0, 'heigth' => 20, 'width' => 20  ) ); ?>&nbsp;Presupuestos</a></h3>
	<div>
		<div style="float: right; position:relative;"><?php echo $this->Html->image( 'galeria/presupuesto.png', array( 'border' => 0, 'width' => 250, 'alt' => 'Pantalla inicial' ) ); ?></div>
	...
	<h3><a href="#"><?php echo $this->Html->image( 'modulos/ventas.jpg', array( 'border' => 0, 'heigth' => 20, 'width' => 20  ) ); ?>&nbsp;Facturas</a></h3>
	<div>
	...
	<h3><a href="#"><?php echo $this->Html->image( 'modulos/recibo.png', array( 'border' => 0, 'heigth' => 20, 'width' => 20  ) ); ?>&nbsp;Recibos</a></h3>
	<div>
	...
	<h3><a href="#"><?php echo $this->Html->image( 'modulos/ctacte.png', array( 'border' => 0, 'heigth' => 20, 'width' => 20  ) ); ?>&nbsp;Cuentas Corrientes</a></h3>
	<div>
	...
	<h3><a href="#"><?php echo $this->Html->image( 'modulos/caja.png'   , array( 'border' => 0, 'heigth' => 20, 'width' => 20  ) ); ?>&nbsp;Control de caja</a></h3>
	<div>
		<div style="float: right; position:relative;"><?php echo $this->Html->image( 'galeria/caja.png', array( 'border' => 0, 'width' => 250, 'alt' => 'Pantalla inicial' ) ); ?></div>
    ...
    <h3><a href="#"><?php echo $this->Html->image( 'modulos/productos.png', array( 'border' => 0, 'heigth' => 20, 'width' => 20  ) ); ?>&nbsp;Productos</a></h3>
	<div>
		<div style="float: right; position:relative;"><?php echo $this->Html->image( 'galeria/productos.png', array( 'border' => 0, 'width' => 250, 'alt' => 'Pantalla inicial' ) ); ?></div>
	...
	<h3><a href="#"><?php echo $this->Html->image( 'modulos/proveedores.jpg', array( 'border' => 0, 'heigth' => 20, 'width' => 20  ) ); ?>&nbsp;Proveedores</a></h3>
	<div>
		<div style="float: right; position:relative;"><?php echo $this->Html->image( 'galeria/pantalla_proveedor.png', array( 'border' => 0, 'width' => 250, 'alt' => 'Pantalla inicial' ) ); ?></div>
		Este m&oacute; le permite mantener una lista simple de sus proveedores con sus datos de contacto.
	</div>	
	<h3><a href="#"><?php echo $this->Html->image( 'modulos/servicios.png', array( 'border' => 0, 'heigth' => 20, 'width' => 20  ) ); ?>&nbsp;Servicio de suscripci&oacute;n</a></h3>
	<div>
